										...
										<div class="row">                                       
											<div class="col-md-6">											
												...
												<select class="form-control" name="id_paciente">
                                                	<?php
														$sal=mysql_query("SELECT * FROM pacientes WHERE estado='s'");				
                            ...
                            <div class="table-responsive">
								<?php 
									if(!empty($_POST['id_paciente'])){ 												
										...
										if(empty($_POST['id'])){
											$oConsulta=new Proceso_Cita('',$id_paciente,$id_medico,$fechai,$observaciones,$fecha,$hora,$horario,$status);
											$oConsulta->crear();
                                    ...
                                    <tbody>
										<?php 
											if(!empty($_POST['buscar'])){
												...
												$pame=mysql_query("SELECT * FROM citas_medicas ORDER BY id DESC LIMIT 10");		 
											}		
