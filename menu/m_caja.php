<!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                   ...
                   <li>
                        <a  href="../pacientes/index.php"><i class="fa fa-user fa-3x"></i> Pacientes</a>
                    </li>
					<li>
                    ...
                    <li>
                        <a class="active-menu"  href="../caja/index.php"><i class="fa fa-bar-chart-o fa-3x"></i> Caja </a>
                    </li>				
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
							...
							<li>
                                <a href="../index.php"> Consultorio</a>
                            </li>
                            <li>
                                <a href="#"> Localidad<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="../departamentos/index.php"> Estados</a>
                                    </li>
                                    <li>
